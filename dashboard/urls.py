...
urlpatterns = [
    ...
    path('products/parameters/add', AddProductParametersView.as_view()),
    path('products/parameters/get',ProductParametersView.as_view()),
    ...
    path('products/types/add',AddProductTypesView.as_view()),
    path('products/types/get',AddProductTypesView.as_view()),
